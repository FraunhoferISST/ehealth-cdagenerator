...
@XmlType(name = "POCD_MT000040.HealthCareFacility", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040HealthCareFacility {
	 ...
	 * 
	 * @return the location possible object is {@link POCDMT000040Place }
	 */
	 ...
	 * 
	 * @return the service provider organization possible object is
