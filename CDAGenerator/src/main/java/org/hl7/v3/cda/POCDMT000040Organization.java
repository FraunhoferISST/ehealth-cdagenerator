...
@XmlType(name = "POCD_MT000040.Organization", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040Organization {
	 ...
	 * 
	 * @return the standard industry class code possible object is {@link CE }
	 */
	 ...
	 * 
	 * @return the as organization part of possible object is
