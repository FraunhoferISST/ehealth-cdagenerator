...
@XmlType(name = "EN", namespace = "urn:hl7-org:v3", propOrder = {
    "content"
})
@XmlSeeAlso({
    ON.class,
    ...
    extends ANY
{
	 ...
	 * "Bob", "Walton", and "Jr.", "Health Level
	 * Seven" and "Inc.", "Lake" and "Tahoe". Gets the value of the content
	 * property.
	 * 
	 * <p>
	 ...
	 * 
	 * @return the content {@link JAXBElement }{@code <}{@link EnFamily }{@code >}
	 *         {@link String } {@link JAXBElement }{@code <}{@link EnSuffix }
	 *         {@code >} {@link JAXBElement }{@code <}{@link EnPrefix }{@code >}
