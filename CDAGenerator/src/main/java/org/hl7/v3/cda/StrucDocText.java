...
@XmlType(name = "StrucDoc.Text", namespace = "urn:hl7-org:v3", propOrder = {
    "content"
})
public class StrucDocText {
	 ...
	 * 
	 * @return the content {@link String } {@link JAXBElement }{@code <}
	 *         {@link StrucDocRenderMultiMedia }{@code >} {@link JAXBElement }
	 *         {@code <}{@link StrucDocSup }{@code >} {@link JAXBElement }{@code <}
	 ...
	 *         {@link StrucDocBr }{@code >} {@link JAXBElement }{@code <}
