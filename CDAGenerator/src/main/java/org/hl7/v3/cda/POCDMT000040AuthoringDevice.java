...
@XmlType(name = "POCD_MT000040.AuthoringDevice", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "code",
...
public class POCDMT000040AuthoringDevice {
	 ...
	 * 
	 * @return the manufacturer model name possible object is {@link SC }
	 */
	 ...
	 * 
	 * @return the software name possible object is {@link SC }
	 */
	 ...
	 * Objects of the following type(s) are allowed in the list
	 * 
	 * @return the as maintained entity {@link POCDMT000040MaintainedEntity }
	 */
	 ...
	 * 
	 * @return the class code possible object is {@link EntityClassDevice }
	 */
