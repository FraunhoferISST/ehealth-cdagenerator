...
@XmlType(name = "POCD_MT000040.CustodianOrganization", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040CustodianOrganization {
	 ...
	 * 
	 * @return the name possible object is {@link ON }
	 */
    public ON getName() {
        return name;
    }
	 ...
	 * 
	 * @return the telecom possible object is {@link TEL }
	 */
	 ...
	 * 
	 * @return the addr possible object is {@link AD }
	 */
    public AD getAddr() {
        return addr;
    }
