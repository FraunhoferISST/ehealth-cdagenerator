...
@XmlType(name = "StrucDoc.Tr", namespace = "urn:hl7-org:v3", propOrder = {
    "thOrTd"
})
public class StrucDocTr {
    ...
    /** The th or td. */
    @XmlElements({
        @XmlElement(name = "th", namespace = "urn:hl7-org:v3", type = StrucDocTh.class),
        @XmlElement(name = "td", namespace = "urn:hl7-org:v3", type = StrucDocTd.class)
    })
	 ...
	 * 
	 * @return the th or td {@link StrucDocTh } {@link StrucDocTd }
	 */
