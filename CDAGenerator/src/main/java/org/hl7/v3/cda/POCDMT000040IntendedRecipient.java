...
@XmlType(name = "POCD_MT000040.IntendedRecipient", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040IntendedRecipient {
	 ...
	 * 
	 * @return the information recipient possible object is
	 ...
	 * 
	 * @return the received organization possible object is
