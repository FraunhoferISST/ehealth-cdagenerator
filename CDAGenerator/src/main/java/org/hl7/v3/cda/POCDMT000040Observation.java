...
@XmlType(name = "POCD_MT000040.Observation", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040Observation {
	 ...
	 * 
	 * @return the derivation expr possible object is {@link ST }
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the interpretationCode property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * Objects of the following type(s) are allowed in the list
	 * 
	 * @return the interpretation code {@link CE }
	 */
	 ...
	 * snapshot. Therefore any modification you make to the returned list will
	 * be present inside the JAXB object. This is why there is not a
	 * <CODE>set</CODE> method for the referenceRange property.
	 * 
	 * <p>
	 * For example, to add a new item, do as follows:
	 * 
	 ...
	 * Objects of the following type(s) are allowed in the list
	 * 
	 * @return the reference range {@link POCDMT000040ReferenceRange }
	 */
	 ...
	 * 
	 * @return the mood code possible object is
