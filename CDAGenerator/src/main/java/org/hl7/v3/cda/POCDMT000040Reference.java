...
@XmlType(name = "POCD_MT000040.Reference", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "seperatableInd",
...
public class POCDMT000040Reference {
	 ...
	 * 
	 * @return the external act possible object is
	 ...
	 * 
	 * @return the external observation possible object is
	 ...
	 * 
	 * @return the external procedure possible object is
	 ...
	 * 
	 * @return the external document possible object is
