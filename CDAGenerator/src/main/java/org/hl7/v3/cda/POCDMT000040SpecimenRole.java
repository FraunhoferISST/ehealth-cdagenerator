...
@XmlType(name = "POCD_MT000040.SpecimenRole", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040SpecimenRole {
	 ...
	 * 
	 * @return the specimen playing entity possible object is
	 ...
	 * 
	 * @return the class code possible object is {@link RoleClassSpecimen }
	 */
