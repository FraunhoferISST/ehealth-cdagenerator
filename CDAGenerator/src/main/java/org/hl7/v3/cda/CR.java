...
@XmlType(name = "CR", namespace = "urn:hl7-org:v3", propOrder = {
    "name",
    "value"
})
public class CR
    extends ANY
{
	 ...
	 * 
	 * @return the name possible object is {@link CV }
	 */
    public CV getName() {
        return name;
    }
	 ...
	 * 
	 * @return the value possible object is {@link CD }
	 */
    public CD getValue() {
        return value;
    }
	 ...
	 * 
	 * @return true, if is inverted possible object is {@link Boolean }
	 */
