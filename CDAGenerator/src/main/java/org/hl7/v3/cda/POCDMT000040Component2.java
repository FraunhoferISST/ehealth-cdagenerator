...
@XmlType(name = "POCD_MT000040.Component2", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "nonXMLBody",
...
public class POCDMT000040Component2 {
	 ...
	 * 
	 * @return the non xml body possible object is
	 ...
	 * 
	 * @return the structured body possible object is
