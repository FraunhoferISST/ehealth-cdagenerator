...
@XmlType(name = "POCD_MT000040.AssignedAuthor", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040AssignedAuthor {
	 ...
	 * 
	 * @return the assigned authoring device possible object is
