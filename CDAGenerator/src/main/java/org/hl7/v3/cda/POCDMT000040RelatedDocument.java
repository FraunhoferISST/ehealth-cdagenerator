...
@XmlType(name = "POCD_MT000040.RelatedDocument", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "parentDocument"
...
public class POCDMT000040RelatedDocument {
	 ...
	 * 
	 * @return the parent document possible object is
	 ...
	 * 
	 * @return the type code possible object is {@link XActRelationshipDocument }
	 */
