...
@XmlType(name = "SLIST_PQ", namespace = "urn:hl7-org:v3", propOrder = {
    "origin",
    "scale",
    "digits"
})
    ...
    extends ANY
{
	 ...
	 * 
	 * @return the origin possible object is {@link PQ }
	 */
    public PQ getOrigin() {
        return origin;
    }
	 ...
	 * 
	 * @return the scale possible object is {@link PQ }
	 */
    public PQ getScale() {
        return scale;
    }
	 ...
	 * 
	 * @return the digits {@link BigInteger }
	 */
