...
@XmlType(name = "POCD_MT000040.AssociatedEntity", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040AssociatedEntity {
	 ...
	 * 
	 * @return the associated person possible object is
	 ...
	 * 
	 * @return the scoping organization possible object is
