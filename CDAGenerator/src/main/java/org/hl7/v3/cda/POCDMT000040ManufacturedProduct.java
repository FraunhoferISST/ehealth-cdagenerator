...
@XmlType(name = "POCD_MT000040.ManufacturedProduct", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040ManufacturedProduct {
	 ...
	 * 
	 * @return the manufactured labeled drug possible object is
	 ...
	 * 
	 * @return the manufactured material possible object is
	 ...
	 * 
	 * @return the manufacturer organization possible object is
	 ...
	 * 
	 * @return the class code possible object is
