...
@XmlType(name = "POCD_MT000040.RegionOfInterest", namespace = "urn:hl7-org:v3", propOrder = {
    "realmCode",
    "typeId",
    "templateId",
    "id",
...
public class POCDMT000040RegionOfInterest {
	 ...
	 * 
	 * @return the code possible object is {@link CS }
	 */
    public CS getCode() {
        return code;
    }
	 ...
	 * Objects of the following type(s) are allowed in the list
	 * 
	 * @return the value {@link POCDMT000040RegionOfInterestValue }
	 */
